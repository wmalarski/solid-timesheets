import { Menu, Transition } from "solid-headless";
            ...
            <div class="px-1 py-1 ">
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    {active ? (
                      <EditIcon class="mr-2 h-5 w-5" aria-hidden="true" />
                    ) : (
                      <EditInactiveIcon
                        class="mr-2 h-5 w-5"
                        aria-hidden="true"
              ...
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    {active ? (
                      <DuplicateIcon class="mr-2 h-5 w-5" aria-hidden="true" />
                    ) : (
            ...
            <div class="px-1 py-1">
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    {active ? (
                      <ArchiveIcon class="mr-2 h-5 w-5" aria-hidden="true" />
                    ) : (
                      <ArchiveInactiveIcon
                        class="mr-2 h-5 w-5"
                        aria-hidden="true"
              ...
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    {active ? (
                      <MoveIcon class="mr-2 h-5 w-5" aria-hidden="true" />
                    ) : (
                      <MoveInactiveIcon
                        class="mr-2 h-5 w-5"
                        aria-hidden="true"
